...
syntax cluster luaStat
      \ contains=@luaExpr,luaIfThen,luaBlock,luaLoop,luaGoto,luaLabel,luaLocal,luaStatement,luaSemiCol,luaErrHand,luaTableSyntax
...
if version >= 508 || !exists("did_lua_syn_inits")
  ...
  HiLink luaParens           Structure
  HiLink luaBraces           Structure
  HiLink luaBrackets         Structure
 ...
 "HiLink luaFuncArgName      Noise
  HiLink luaFuncCall         luaFuncId
  HiLink luaFuncId           Structure
 ...
 "HiLink luaFuncParens       Noise
  ...
  HiLink luaTableSyntax Identifier
